...
class Mega_Blog_Pro_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'tp_gutenberg';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'mega-blog-pro' ), $i ),
	...
	function get_footer_widgets_content( $args ) {
		...
		$args = wp_parse_args( (array) $args, array(
			'container'       => 'div',
			'container_class' => $this->custom_footer_widget_class( 'footer-widget-area page-section unequal-width' ),
			'container_style' => '',
			'container_id'    => '',
			'wrap_class'      => 'hentry',
			'before'          => '',
...
// Initialize.
$mega_blog_pro_footer_widgets = new Mega_Blog_Pro_Footer_Widgets();
